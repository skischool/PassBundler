...
namespace Infrastructure.CrossCutting.IoC
{
    public static class IoCFactory
    {
        ...
        static void ConfigureRootContainer(IUnityContainer container)
        {
            ...
            container.RegisterType<IBundleService, BundleService>(new TransientLifetimeManager());
            ...
            container.RegisterType<IBundleRepository, BundleRepository>(new TransientLifetimeManager());
